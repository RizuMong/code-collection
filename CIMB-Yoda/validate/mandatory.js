var payload = {
  ...
  "email": "Fanta@mailinator.com",
  "employee_category": "Permanent",
  "employee_name": "fantasy",
  "employee_status": "Active",
  "filename": "CIMB_SMART_YODA_202410141136.csv",
  "gender": "Male",
  "grade": "U10",
  "id": "NhEOpIiHg",
  "ids": "NhEOpIiHg",
  ...
  "npwp": "92340000001",
  "org_level": "D4",
  "position_code": "890005-TESTUAT",
  "position_name": "890005-TESTUAT",
  "postal_code": "13724",
  "provinsi": "DKI Jakarta",
  "status_process": "pending",
  "sub_directorate": "Strategic Procurement & Admin Property Management ID",
  "termination_date": 0,
  "town_of_birth": "Jakarta",
  "town_or_city": "Jakarta Timur",
  "updated_at": 1728880653999,
  "updated_by": 166466
}


// dibuat simulasi kalau datanya array dari kiriman ftp
var dataYoda = [payload];
...
dataYoda.forEach(function (each_data) {
    ...
    mandatoryFields.forEach(function (field) {
        if (each_data.org_level !== "D0" || (
            ...
            ["ds_email", "ds_nip", "ds_name", "ds_position_name"].indexOf(field) === -1
        )) {
...
if (!dataCreate[0].data_valid) {
    // var createLogIssue = _hitFunction("func_create_log_import_yoda", {
    //     "ids": payload.ids,
    //     "message": dataCreate[0].notes
    // });

    // var createLogResponse = _hitFunction("func_create_log_response_yoda", {
    //     "data": payload,
    //     "filename": payload.filename,
    //     "status": "Failed"
    // });

    console.log("Record Mandatory tidak terisi");
    // _stopAutomation();
} else {
    // var createLogResponse = _hitFunction("func_create_log_response_yoda", {
    //     "data": payload,
