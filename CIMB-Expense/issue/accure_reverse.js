...
var data_sharing_cost = [
  {
      ...
      "initiated_amount_mcx": {
          "convertion_amount": -416581016.4000001,
          "origin_amount": -416581016.4000001,
          "origin_currency": "IDR",
          "rate": 1,
          "target_currency": "IDR"
      },
...
wrapAutomation(function () {
  ...
  data_sharing_cost.forEach(function (item) {
      ...
      _log({
        amount: amount,
        amount_initiated_origin: amount_initiated_origin,
      });
      if (amount > amount_initiated_origin) {
          // _log("Masuk Error");
          _log('Maksimal jumlah dana untuk ' + name + ' sebesar ' + amount);
