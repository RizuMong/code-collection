var get_datas = [
    {
        ...
        "estimate_end_date": 1779245228328,
        "estimate_man_hour": 1,
        "estimate_start_date": 1779243886345,
        "id": "58gSSuZQvZCZ",
        "ids": "58gSSuZQvZCZ",
        "is_project": "YES",
...
var start_date = 1779243886345;
var end_date = 1779245228328;

var results = [];

get_datas.forEach(function (item) {
    if (item.estimate_start_date <= end_date && item.estimate_end_date >= start_date) {
        results.push(item);
    };
});
...
//         "estimate_man_hours": 1,
//         "id": "hfGTJvgBCv0g",
//         "job_position_id": {
//             "id": "1",
//             "name": "Solution Engineer"
//         },
//         "manhour_utilization_percentage": 100,
//         "name": "Rizki Haddi Prayoga",
