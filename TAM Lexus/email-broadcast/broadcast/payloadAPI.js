...
var payloadAPI = {
  ...
  contactNumber: getDetailCustomer.phone_number ? getDetailCustomer.phone_number : "",
  vinNumber: getDetailCustomer.vin && getDetailCustomer.vin.name ? getDetailCustomer.vin.name : "",
  machineNumber: getDetailCustomer.engine_number ? getDetailCustomer.engine_number : "",
  plateNumber: getDetailCustomer.plate_number && getDetailCustomer.plate_number.name ? getDetailCustomer.plate_number.name : "",
  typeLexus: getDetailCustomer.product_description ? getDetailCustomer.product_description : "",
  deliveryDate: getDetailCustomer.customer_receipt_date ? getDetailCustomer.customer_receipt_date : "",
