...
var dayParts = getDatePartsInRange(1760461200000, 1761066000000);

// convert array → string list
var day = dayParts.day.join(", ");
var month = dayParts.month.join(", ");
var year = dayParts.year.join(", ");
