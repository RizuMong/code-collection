...
var rejectReason = "Nominal terlalu besar"; // dinamis berdasarkan data
...
var messageDetail =
  ...
  '<tr><td colspan="3" style="font-weight:bold; text-align:left; font-size:14px;">Pengajuan anda dengan detil sbb:</td></tr>' +
  ...
  "<tr><td style='font-size:14px;'>Belum di setujui, Note: " + (rejectReason || "-") + "</td><td></td><td></td></tr>" +
  '<tr><td colspan="3"></td></tr>' +
